...
if (! function_exists('country')) {
     ...
     * @return \Cmcww\LaravelIntl\Country|string
     */
...
if (! function_exists('currency')) {
     ...
     *
     * @return \Cmcww\LaravelIntl\Currency|string
     */
    function currency()
    {
...
if (! function_exists('language')) {
     ...
     * @return \Cmcww\LaravelIntl\Language|string
     */
...
if (! function_exists('number')) {
     ...
     * @param array $options
     * @return \Cmcww\LaravelIntl\Number|string
     */
